...
\namesection{Marcin}{Łagowski}{ \urlstyle{same}\url{https://emlagowski.github.io} \\
...
\custombold{Thesis:} Next location recommendation basing on sequential rules mining, recurrent neural network and spatial data from social networks.
\sectionsep
...
\custombold{Thesis:} SociaInfo – System and mobile application supporting ad-hoc meetings.
\sectionsep
...
\location{ September 2019 – until now | Warsaw, Poland}
Extending the functionality of the document management and satellite systems. Automation of CI \& CD processes.

\custombold{Stack:} Spring Boot, Kubernetes, Spock (Groovy), PostgreSQL, Jenkins, Docker, Linux
\sectionsep
...
\custombold{Stack:} Kotlin, Spring Boot, Hibernate, Spock (Groovy), PostgreSQL, Docker, Linux
\sectionsep
...
% \begin{tightemize}
% \item development of services in microservices architecture
% \item implementation of multi currency card
% \item migration of services to Spring Boot
% \item implementation of Hystrix into services
% \item contribution to the CI / CD processes
% \end{tightemize}

\custombold{Stack:} Java 8, Spring Boot, Hystrix, Consul, Vault, PostgreSQL, Redis, Docker, Grafana, Kibana, SonarQube
\sectionsep
...
\custombold{Stack:} Java 8, Play! Framework, Docker, Swarm, Cassandra, CQL, PostgreSQL, Guice, Scala, Spark, Zeppelin, RabbitMQ, SBT, Git, IntelliJ, Checkstyle, Linux, Spock
\sectionsep
...
\custombold{Stack:} Java 8, Play! Framework, Docker, PostgreSQL, Git, IntelliJ, Linux
\sectionsep
...
\custombold{Stack:} Java 8, Android, Kotlin, JavaFX, Git
\sectionsep
