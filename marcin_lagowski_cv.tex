...
\end{tightemize}
Stack: Java 8, Spring Boot, Hystrix, Consul, Vault, PostgreSQL, Redis, Docker, Grafana, Kibana, SonarQube
\sectionsep
...
\end{tightemize}
Stack: Java 8, Play! Framework, Docker, Swarm, Cassandra, CQL, PostgreSQL, Guice, Scala, Spark, Zeppelin, RabbitMQ, SBT, Git, IntelliJ, Checkstyle, Linux, Spock
\sectionsep
...
\end{tightemize}
Stack: Java 8, Play! Framework, Docker, PostgreSQL, Git, IntelliJ, Linux
\sectionsep
...
\end{tightemize}
Stack: Java 8, Android, Kotlin, JavaFX, Git
\sectionsep
