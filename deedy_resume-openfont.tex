...
\descript{BEng in Telecommunications}
...
\location{ December 2015 – until now | Warsaw, Poland}
Developing backend of asset management application. %with high availability and automated deployment.
...
\runsubsection{Data Contact}
\descript{| Supervisor Assistant }
\location{ June 2013 – September 2014 | Warsaw, Poland}
\begin{tightemize}
